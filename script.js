document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        } else if (field.maxLength > 0 && field.maxLength < 524288 && value.length > field.maxLength) {
  ...
  function clearFormErrors(form) {
    ...
    const existingMessages = form.querySelectorAll('.form-success-message, .form-submit-error');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "AICON משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '83dea51d-1181-4727-a7a2-44a3e0474216',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '83dea51d-1181-4727-a7a2-44a3e0474216';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '83dea51d-1181-4727-a7a2-44a3e0474216';
